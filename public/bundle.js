        ...
        (function () {
            ...
            function ge(e) {
                ...
                return (ge = function (e) {
                    ...
                    function r() {
                        return me(e, arguments, ye(this).constructor)
                    }
                    return (
            ...
            var je = (function (e) {
                    ...
                    var b = (function (e, n, o, i) {
                        void 0 === o && (o = [])
                        var a = 'function' == typeof n ? Ee(n) : [n, o, i],
                            c = a[0],
                            u = a[1],
                            f = a[2]
                        return function (n, o) {
                    ...
                    return { name: n, reducer: b, actions: v, caseReducers: h }
                })({
                ...
                })({ reducer: re({ incrementDecrement: je.reducer }) }),
                Ne = new (function e() {
                    var t, n
                    return (
                        (function (e, t) {
            ...
            Object.freeze(Ne), (window.mapAllDispatch = Ne)
            var ke,
                Te = ['checked', 'selected', 'value'],
                _e = {},
                Ie = !1,
                Me = function (e) {
            ...
            var Le = function (e, t) {
                    ...
                    if ('object' === n) {
                        var r = {}
                        for (var o in e)
                            e.hasOwnProperty(o) && (r[o] = Le(e[o], t))
                        return r
                    }
                    return 'array' === n
                        ? e.map(function (e) {
                ...
                ze = function (e) {
                    return {
                        get: function (t, n) {
                            return ['object', 'array'].indexOf(Me(t[n])) > -1
                                ? new Proxy(t[n], ze(e))
                                : t[n]
                        },
                        set: function (t, n, r) {
                            return t[n] === r || ((t[n] = r), Fe(e)), !0
                        },
                    }
                },
                Be = function (e, t) {
            ...
            Ke.Store = function (e) {
                return (e.lagoon = !0), new Ke(null, e)
            }
            var Ue = function (e, t) {
                ...
                He = function (e, t) {
                    t.forEach(function (t) {
                        if ('class' === t.att) e.className = ''
                            ...
                            Ue(e, Array.prototype.slice.call(e.style))
                        else {
                            if (t.att in e)
                                try {
                                    e[t.att] = ''
                    ...
                    1 === e.nodeType &&
                        (Array.prototype.forEach.call(e.attributes, function (
                            ...
                            t.name.length < 8 ||
                                ...
                                (We(e, [
                                    Ye(t.name.slice(7).toLowerCase(), t.value),
                                ]),
                                He(e, [Ye(t.name, t.value)]))
                        }),
                        e.childNodes &&
                ...
                Ve = function (e, t, n) {
                    ...
                    o.forEach(function (e, o) {
                        if (!r[o])
                            return Je(e), void t.appendChild(e.cloneNode(!0))
                        if (Ze(e) === Ze(r[o])) {
                            if (
                                ((function (e, t) {
                                    var n = Xe(e, !0),
                                ...
                                if (
                                    ...
                                    e.childNodes.length > 0 && Ve(e, r[o], n)
                                }
                            }
            ...
            ;(Ke.emit = function (e, t, n) {
                var r
                if (!e || !t)
                    return Re('You did not provide an element or event name.')
                ;(r = new CustomEvent(t, { bubbles: !0, detail: n })),
                    e.dispatchEvent(r)
            }),
                (Ke.prototype.render = function () {
                    if (this.lagoon) $e(this.attached, this)
                    else {
                        if (!this.template)
                            return Re('No template was provided.')
                        var e =
                            'string' === Me(this.elem)
                        ...
                        var t = Le(
                            ...
                            n =
                                'function' === Me(this.template)
                                    ...
                                    : this.template
                        if (!(['string', 'number'].indexOf(Me(n)) < 0)) {
                ...
                (Ke.prototype.detach = function (e) {
                    var t = 'array' === Me(e) ? e : [e],
                        n = this
